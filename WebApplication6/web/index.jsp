            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="professor-card">
                        <img src="ruta/a/la/imagen_del_profesor.jpg" alt="Profesor 1" class="professor-image">
                        <h3>Profesor Nombre 1</h3>
                        <p>Descripción del profesor 1. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                </div>
                <!-- Añadir más cartas según sea necesario -->
                <div class="col-md-4">
                    <div class="professor-card">
                        <img src="ruta/a/la/imagen_del_profesor.jpg" alt="Profesor 2" class="professor-image">
                        <h3>Profesor Nombre 2</h3>
                        <p>Descripción del profesor 2. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="professor-card">
                        <img src="ruta/a/la/imagen_del_profesor.jpg" alt="Profesor 3" class="professor-image">
                        <h3>Profesor Nombre 3</h3>
                        <p>Descripción del profesor 3. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                </div>
            </div>
        </div>
